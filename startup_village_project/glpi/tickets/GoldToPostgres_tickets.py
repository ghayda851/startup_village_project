...
gold_kpi_status_distribution_period_path = f"{gold_root}/tickets_kpis/kpi_status_distribution_period"
...
df_kpi_status_distribution_period = spark.read.format("delta").load(gold_kpi_status_distribution_period_path)
...
print(df_kpi_status_distribution_period.columns)
...
df_status_dist_out = df_kpi_status_distribution_period.select(*df_kpi_status_distribution_period.columns)
...
print("kpi_status_distribution_period:", df_status_dist_out.columns)
...
tables = [
    ...
    "kpi_status_distribution_period",
...
(df_status_dist_out.write.mode("append").jdbc(jdbc_url, f"{schema}.kpi_status_distribution_period", properties=jdbc_props))
