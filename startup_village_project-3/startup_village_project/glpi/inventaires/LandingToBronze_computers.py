...
# MAGIC %md
# MAGIC %md
# MAGIC # GLPI Computers — Landing to Bronze (incremental by ingestion_date)
# MAGIC
...
dbutils.fs.ls("abfss://landing@startupvillagedatalake.dfs.core.windows.net/glpi/computers/")
